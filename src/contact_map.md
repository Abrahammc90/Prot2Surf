...
`contact_map` evaluates residue proximity to a surface across encounter complexes.
...
```bash
./contact_map -pdb2 p2_noh.pdb -complexes assoc_complexes -nb_encounters 5000 -threshold 6.0
```
